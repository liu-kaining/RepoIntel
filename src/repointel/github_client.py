...
class GitHubClient:
    ...
    def _dry_run_candidates(self) -> list[RepoCandidate]:
        ...
        samples = [
            ("nova-labs/flux-agent", "Rust", "Autonomous coding agent with sandboxed tool execution.", 4200, 210),
            ("pixelmind-ai/rag-pipeline-kit", "Python", "Production RAG pipeline with eval harness and observability.", 3100, 180),
            ("edgeforge/mcp-gateway", "Go", "Unified MCP gateway for multi-model agent orchestration.", 2800, 150),
            ("tensorlite/onnx-runner", "C++", "Cross-platform ONNX inference runtime for edge devices.", 2500, 120),
            ("cloudnative-kit/helm-gen", "TypeScript", "AI-assisted Helm chart generator with policy checks.", 2200, 95),
            ("devscribe/cli-audit", "Python", "CLI that audits repo health, CI gaps, and supply-chain risk.", 1900, 88),
            ("openmesh/sync-engine", "Rust", "CRDT-based real-time sync engine for local-first apps.", 1700, 76),
            ("promptworks/eval-bench", "Python", "Benchmark suite for LLM prompt quality and regression.", 1500, 70),
            ("byteflow/wasm-runtime-lite", "Rust", "Lightweight WASM runtime for serverless edge functions.", 1300, 65),
            ("agentkit/observability", "Go", "OpenTelemetry-native tracing for AI agent workflows.", 1100, 58),
            ("codewave/lsp-bridge", "TypeScript", "Bridge LSP servers into agent toolchains with caching.", 980, 52),
            ("modelhub/quant-kit", "Python", "Post-training quantization toolkit with accuracy reports.", 870, 48),
            ("infraops/gitops-ai", "Go", "GitOps controller with AI-generated rollout plans.", 760, 42),
            ("datasync/vector-store-lite", "Rust", "Embedded vector DB for on-device RAG.", 650, 38),
            ("buildkit/sbom-scanner", "Python", "SBOM generator and vulnerability scanner for CI.", 540, 32),
            ("neuralpipe/stream-llm", "C++", "Streaming LLM inference server with batching.", 480, 28),
            ("toolforge/mcp-tools", "Python", "Composable MCP tool library for developer agents.", 420, 25),
        ]
        repos: list[RepoCandidate] = []
